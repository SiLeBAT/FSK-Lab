...
/**
 * An extension point providing classes for serializing data in KNIME and
 * deserializing it in the python workspace.
 * 
...
public class KnimeToPythonExtension {
    ...
    public KnimeToPythonExtension(String id, String pythonDeserializerPath,
            SerializerFactory<? extends DataValue> javaSerializer) {
        m_id = id;
