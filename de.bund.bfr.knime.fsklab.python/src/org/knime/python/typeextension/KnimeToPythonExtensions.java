...
/**
 * Class for administering all {@link KnimeToPythonExtension}s defined as
 * extension points.
 * 
...
public class KnimeToPythonExtensions {
     ...
     * {@link KnimeToPythonExtension}s. Also wrap them up and add them as
     * available {@link KnimeToPythonExtension}s for org.knime.python2.
     */
    @SuppressWarnings({ "unchecked" })
    public static void init() {
        IConfigurationElement[] configs = Platform.getExtensionRegistry()
                .getConfigurationElementsFor("org.knime.python.typeextension.knimetopython");
    ...
    /**
     * Return the {@link Serializer} for the given id. The {@link Serializer}
     * instance is saved and returned on every successive call.
     * 
     * @param id
     *            the {@link Serializer}'s id
