 ...
 */
package de.bund.bfr.knime.fsklab.python;
...
import de.bund.bfr.knime.fsklab.python.kernel.PythonKernelTester;
...
public class Activator implements BundleActivator {
     ...
     */
    public static final String PLUGIN_ID = "de.bund.bfr.knime.fsklab.python";
    ...
    public static String getPython2Command() {
    	return PreferenceInitializer.getPythonProvider().getPythonHome();
    }
