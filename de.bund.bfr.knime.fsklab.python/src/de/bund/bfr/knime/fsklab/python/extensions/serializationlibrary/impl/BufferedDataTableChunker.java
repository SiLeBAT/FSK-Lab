...
import de.bund.bfr.knime.fsklab.python.extensions.serializationlibrary.interfaces.TableChunker;
...
/**
 * Used for splitting a {@link BufferedDataTable} into chunks. Assures that only one {@link TableIterator} on the
 * underlying {@link BufferedDataTable} is open at a time. If new {@link TableIterator} is requested the current one is
 * closed and the new one starts at the position of the current iterator in the table.
 *
...
public class BufferedDataTableChunker implements TableChunker {
    ...
    /**
     * Internal class shared with the {@link BufferedDataTableIterator} for ensuring the correct row pointer on both
     * ends.
     */
