...
public class ReaderNodeUtilTest {
	...
	public void testAddSuffixes_noDup_shouldReturnEquals() {
		...
		assertEquals("firstIn"+ JoinerNodeModel.SUFFIX_FIRST ,ReaderNodeUtil.addSuffix(firstModelParameters, "firstIn"));
		assertEquals("secondIn" + JoinerNodeModel.SUFFIX_SECOND,ReaderNodeUtil.addSuffix(firstModelParameters, "secondIn"));
	...
	public void testAddSuffixes_withDup_shouldReturnEquals() {
		...
		assertEquals("firstIn"+ JoinerNodeModel.SUFFIX_FIRST ,ReaderNodeUtil.addSuffix(firstModelParameters, "firstIn_dup"));
		assertEquals("secondIn" + JoinerNodeModel.SUFFIX_SECOND,ReaderNodeUtil.addSuffix(firstModelParameters, "secondIn"));
