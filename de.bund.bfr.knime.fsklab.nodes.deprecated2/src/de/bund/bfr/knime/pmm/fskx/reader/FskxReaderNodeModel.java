...
public class FskxReaderNodeModel extends NodeModel {
	...
	protected PortObject[] execute(final PortObject[] inData, final ExecutionContext exec)
			throws CombineArchiveException, REXPMismatchException, RException, InvalidPathException, IOException {
		...
		RPortObject rObj;
		if (portObj.workspace == null) {
			rObj = new RPortObject(FileUtil.createTempFile("workspace", ".r"));
		} else {
			rObj = new RPortObject(portObj.workspace);
		}
	...
	// private static Map<String, DataType> getTypesFromAssignments(String
	// paramScript) {
