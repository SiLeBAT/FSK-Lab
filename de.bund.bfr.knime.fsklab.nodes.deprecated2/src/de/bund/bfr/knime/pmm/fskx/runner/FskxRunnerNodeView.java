 ...
 * @author Heiko Hofer
 */
public class FskxRunnerNodeView extends NodeView<FsxkRunnerNodeModel> {
	 ...
	 */
	public FskxRunnerNodeView(final FsxkRunnerNodeModel nodeModel) {
		super(nodeModel);
	...
	protected void modelChanged() {
		final FsxkRunnerNodeModel model = super.getNodeModel();
