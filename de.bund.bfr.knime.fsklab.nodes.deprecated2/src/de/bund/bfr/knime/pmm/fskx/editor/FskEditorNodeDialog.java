...
public class FskEditorNodeDialog extends DataAwareNodeDialogPane {
	...
	protected void loadSettingsFrom(NodeSettingsRO settings, PortObject[] input) throws NotConfigurableException {
		...
		try {
			...
			/*
			 * Take data from the inputs if: 1) all the scripts are empty then the editor is
			 * new, 2) If FSK objects are different then the editor was connected to a
			 * different node and its settings should be cleared
			 */
