...
public class MetaDataPane extends JScrollPane {
	...
	private static enum Col {
		Model_Name, Model_Id, Model_Link, Organism_Name, Organism_Detail, Environment_Name, Environment_Detail, Model_Creator, Model_Family_Name, Model_Contact, Software, Model_Reference_Description, Model_Reference_Description_Link, Model_Created_Date, Model_Modified_Date, Model_Rights, Model_Notes, Model_Curation_Status, Model_Type, Model_Subject, Model_Food_Process, Dependent_Variable, Dependent_Variable_Unit, Dependent_Variable_Type, Dependent_Variable_Min, Dependent_Variable_Max, Independent_Variable, Independent_Variable_Units, Independent_Variable_Types, Independent_Variable_Mins, Independent_Variable_Maxs, Independent_Variable_Values, Has_Data
	}
	...
	private static class TableModel extends AbstractTableModel {
		...
		public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
			...
			case Dependent_Variable_Unit:
				...
				break;
			case Dependent_Variable_Type:
				template.dependentVariable.type = Strings.isNullOrEmpty(stringValue) ? null
