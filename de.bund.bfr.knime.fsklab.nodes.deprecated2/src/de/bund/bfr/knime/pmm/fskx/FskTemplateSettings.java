...
public class FskTemplateSettings {
  ...
  public void loadFromNodeSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
    ...
    try {
      ...
      template.referenceDescriptionLink =
          settings.getString(Key.reference_description_link.name(), null);
      ...
      template.dependentVariable.type =
          typeAsString == null ? null : DataType.valueOf(typeAsString);
  ...
  public void saveToNodeSettings(final NodeSettingsWO settings) {
    ...
    settings.addString(Key.model_link.name(),
        template.modelLink == null ? null : template.modelLink.toString());
    ...
    settings.addString(Key.software.name(),
        template.software == null ? null : template.software.name());
    ...
    settings.addString(Key.reference_description_link.name(),
        template.referenceDescriptionLink == null ? null
    ...
    settings.addString(Key.modified_date.name(), template.modifiedDate == null ? null
    ...
    settings.addString(Key.subject.name(),
        template.subject == null ? "" : template.subject.fullName());
    ...
    // Independent variables
    {
      ...
      String[] values =
          template.independentVariables.stream().map(v -> v.value).toArray(String[]::new);
