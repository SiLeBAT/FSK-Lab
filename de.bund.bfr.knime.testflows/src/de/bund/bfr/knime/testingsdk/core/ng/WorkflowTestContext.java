...
/**
 * Shared context for all testcases. It is used to exchange information that is needed by several testcases, such as the workflow
 * manager, a list of pre-executed nodes, etc.
 *
 * @author Thorsten Meinl, KNIME.com, Zurich, Switzerland
 */
public class WorkflowTestContext {
    private final Map<SingleNodeContainer, List<AbstractNodeView<? extends NodeModel>>> m_views = new HashMap<SingleNodeContainer, List<AbstractNodeView<? extends NodeModel>>>();
    ...
    /**
     * Sets the workflow manager and records the nodes (executed and loaded) in the workflow. In addition also the testflow
     * configuration is read.
     *
     * @param manager
     *            a workflow manager
     * @throws IOException
     *             if an I/O error occurs while reading the testflow configuration
     * @throws InvalidSettingsException
     *             if the settings of the Testflow Configuration node are invalid
     */
    ...
    /**
     * Returns the configuration for this test workflow. Maybe <code>null</code> until the the workflow manager has been set via
     * {@link #setWorkflowManager(WorkflowManager)}.
     *
