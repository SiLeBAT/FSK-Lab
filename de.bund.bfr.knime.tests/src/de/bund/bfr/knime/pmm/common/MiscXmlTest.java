...
public class MiscXmlTest {
	...
	public void testConstructors() throws Exception {
		...
		final MiscXml misc1 = new MiscXml(0, "name", "description", .0, Arrays.asList("category"), "unit", "dbuuid");
		...
		final MiscXml misc2 = new MiscXml(0, "name", "description", .0, Arrays.asList("category"), "unit", "origUnit", "dbuuid");
		...
		final MiscXml misc3 = new MiscXml(misc2);
		...
		final Element element = new Element(MiscXml.ELEMENT_MISC);
		...
		final MiscXml misc4 = new MiscXml(element);
	...
	public void testToXmlElement() throws Exception {
		final MiscXml misc = new MiscXml(0, "name", "description", .0, Arrays.asList("category"), "unit", "origUnit", "dbuuid");
		final Element element = misc.toXmlElement();
