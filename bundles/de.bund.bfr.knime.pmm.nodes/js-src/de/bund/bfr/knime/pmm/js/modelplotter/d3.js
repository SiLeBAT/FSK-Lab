...
d3 = function() {
  ...
  var d3_select = function(s, n) {
	current = document.getElementById(s.split("#")[1]);
	//current = n.querySelector(s);

	return  current;
    //return null// n.querySelector(s);
  ...
  function d3_selection_style(name, value, priority) {
    ...
    function styleConstant() {
    	...
    	if(this.style == undefined){
    		this.style = CSS2Properties;
    		
    	}else{
    		CSS2Properties = this.style;
    	}
