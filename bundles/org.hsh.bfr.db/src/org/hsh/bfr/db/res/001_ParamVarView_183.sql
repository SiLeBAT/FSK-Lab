...
SELECT
    ...
    ARRAY_AGG("ParamDescription") AS "ParamDescription",
    ARRAY_AGG( "Parametertyp" )AS "Parametertyp",
    ...
    ARRAY_AGG( "ParamP" )AS "ParamP",
    ARRAY_AGG( "Paramt" )AS "Paramt",
...
FROM(
    ...
    FROM(
        ...
        SELECT
            ...
            END
            AS "Parametername",
		 "ModellkatalogParameter"."Beschreibung" AS "ParamDescription",
		 "ModellkatalogParameter"."Parametertyp" AS "Parametertyp",
            "Wert",            
    ...
    GROUP BY "GeschaetztesModell", "Parametername", "ParamDescription", "Parametertyp", "ZeitEinheit", "Einheiten", "EinheitenOT", "OT", "Kategorie", "Einheit"
