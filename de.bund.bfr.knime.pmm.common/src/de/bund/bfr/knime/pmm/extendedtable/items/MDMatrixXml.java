...
public class MDMatrixXml extends MatrixXml implements PmmXmlElementConvertable {
	...
	public MDMatrixXml(MatrixXml matrix) {
	...
	/**
	 * Generate a {@link org.jdom2.Element} with name "mdMatrix" and properties:
	 * <ul>
	 * <li>Integer "id"
	 * <li>String "name"
	 * <li>String "detail"
