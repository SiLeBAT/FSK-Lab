...
public class MLiteratureItem extends LiteratureItem implements PmmXmlElementConvertable {
	...
	/** Copy constructor. */
	public MLiteratureItem(final LiteratureItem lit) {
	...
	/**
	 * Generate a {@link org.jdom2.Element} with name "ModelLiterature" and
	 * properties:
	 * <ul>
	 * <li>String "author"
	 * <li>Integer "year"
