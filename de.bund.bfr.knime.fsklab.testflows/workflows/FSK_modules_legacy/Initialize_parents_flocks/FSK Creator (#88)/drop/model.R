##########################################################################################
# initialize_parents_flocks = function(n.iter, Npos, Ntotal)
# 
# DESCRIPTION: 
...
# Npos			integer      number of positive flocks
# Ntotal		integer	     total number of flocks on farm/hatchery		
#
...
initialize_parents_flocks = function(n_iter, Npos, Ntotal){
  Prevalence = 100*(rbeta(n_iter, shape1 = Npos + 1, shape2 = Ntotal - Npos + 1 ))
  return(Prevalence)
}

result <- initialize_parents_flocks(n_iter, Npos, Ntotal)
