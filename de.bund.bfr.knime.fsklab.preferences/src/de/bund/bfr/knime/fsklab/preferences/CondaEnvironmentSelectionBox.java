...
import de.bund.bfr.knime.fsklab.python2.config.AbstractCondaEnvironmentCreationObserver;
...
import de.bund.bfr.knime.fsklab.python2.config.ObservableValue;
...
public final class CondaEnvironmentSelectionBox extends Composite {
     ...
     */
    public CondaEnvironmentSelectionBox(final RPythonVersion rPythonVersion, final SettingsModelString environmentModel,
        ...
        this(rPythonVersion, environmentModel, availableEnvironmentsModel, headerLabel, selectionBoxLabel,
     ...
     * @param parent The parent widget.
     */
    public CondaEnvironmentSelectionBox(final RPythonVersion pythonVersion, final SettingsModelString environmentModel,
        final ObservableValue<CondaEnvironmentIdentifier[]> availableEnvironmentsModel, final String headerLabel,
        final String selectionBoxLabel, final SettingsModelString infoMessageModel,
     ...
     *
     * @param rPythonVersion The Python version of the Conda environment intended for selection/creation.
     * @param environmentModel The settings model for the Conda environment directory. May be updated asynchronously,
     *            that is, in a non-UI thread.
     * @param availableEnvironmentsModel The list of the available Conda environments. May be updated asynchronously,
     *            that is, in a non-UI thread.
    ...
    public CondaEnvironmentSelectionBox(final RPythonVersion rPythonVersion, final SettingsModelString environmentModel,
        ...
        environmentCreationButton.setToolTipText("Create a new preconfigured Conda environment for "
            + rPythonVersion.getName() + " that contains all packages required by the KNIME Python integration.");
