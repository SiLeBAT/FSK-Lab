...
public abstract class AbstractCondaEnvironmentsPanel<D extends CondaEnvironmentCreationDialog, W>
    ...
    public AbstractCondaEnvironmentsPanel(final CondaEnvironmentsConfig config,
        ...
        final CondaEnvironmentCreationObserver rEnvironmentCreator,final W parent) {
        super(config, parent);
        final W panel = getPanel();
        createCondaDirectoryPathStatusWidget(config.getCondaInstallationInfo(), config.getCondaInstallationError(),
            panel);
        ...
        createREnvironmentWidget(config.getRConfig(), rEnvironmentCreator, panel);
    }

    protected abstract void createCondaDirectoryPathStatusWidget(SettingsModelString installationInfoMessage,
    ...
    protected abstract void createREnvironmentWidget(CondaEnvironmentConfig python3Config,
            CondaEnvironmentCreationObserver python3EnvironmentCreator, W panel);
}
