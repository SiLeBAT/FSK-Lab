...
public final class CondaEnvironments {
    ...
    private static final String PLUGIN_ID = "de.bund.bfr.knime.fsklab.preferences";
    ...
    private static String getFileStemForVersion(final Version condaEnvVersion) {
        return "py" //
            + Integer.toString(condaEnvVersion.getMajor()) //
            + (condaEnvVersion.getMinor() != 0 ? Integer.toString(condaEnvVersion.getMinor()) : "") //
            + (condaEnvVersion.getRevision() != 0 ? Integer.toString(condaEnvVersion.getRevision()) : "") //
            + "_knime";
    }
