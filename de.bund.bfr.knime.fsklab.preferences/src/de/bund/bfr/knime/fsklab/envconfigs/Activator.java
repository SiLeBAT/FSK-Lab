...
public final class Activator implements BundleActivator {
     ...
     */
    public static final String PLUGIN_ID = "de.bund.bfr.knime.fsklab.preferences";
    ...
    private static void initCondaEnvPropDefaultEnv() {
        CondaEnvironmentPropagationNodeFactory.addDefaultCondaEnvironmentSelector(envs -> {
            ...
            final String environmentDirectory = pythonVersion == RPythonVersion.PYTHON2 //
                ? PythonPreferences.getPython2CondaEnvironmentDirectoryPath() //
                : (pythonVersion == RPythonVersion.PYTHON3 ? PythonPreferences.getPython3CondaEnvironmentDirectoryPath() :
                	PythonPreferences.getRCondaEnvironmentDirectoryPath());
