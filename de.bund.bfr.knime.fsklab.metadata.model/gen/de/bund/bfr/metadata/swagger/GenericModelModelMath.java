...
public class GenericModelModelMath {
  ...
  private List<Exposure> exposure = null;

  @SerializedName("event")
  private List<String> event = null;

  public GenericModelModelMath parameter(List<Parameter> parameter) {
    this.parameter = parameter;
    return this;
  }

  public GenericModelModelMath addParameterItem(Parameter parameterItem) {
  ...
  **/
  ...
  public GenericModelModelMath qualityMeasures(List<QualityMeasures> qualityMeasures) {
    this.qualityMeasures = qualityMeasures;
    return this;
  }

  public GenericModelModelMath addQualityMeasuresItem(QualityMeasures qualityMeasuresItem) {
  ...
  **/
  ...
  public GenericModelModelMath modelEquation(List<ModelEquation> modelEquation) {
    this.modelEquation = modelEquation;
    return this;
  }

  public GenericModelModelMath addModelEquationItem(ModelEquation modelEquationItem) {
  ...
  **/
  ...
  public GenericModelModelMath fittingProcedure(String fittingProcedure) {
  ...
  **/
  ...
  public GenericModelModelMath exposure(List<Exposure> exposure) {
    this.exposure = exposure;
    return this;
  }

  public GenericModelModelMath addExposureItem(Exposure exposureItem) {
    if (this.exposure == null) {
      this.exposure = new ArrayList<Exposure>();
    }
  ...
  **/
  ...
  public GenericModelModelMath event(List<String> event) {
    this.event = event;
    return this;
  }

  public GenericModelModelMath addEventItem(String eventItem) {
    if (this.event == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GenericModelModelMath genericModelModelMath = (GenericModelModelMath) o;
    return Objects.equals(this.parameter, genericModelModelMath.parameter) &&
        Objects.equals(this.qualityMeasures, genericModelModelMath.qualityMeasures) &&
        Objects.equals(this.modelEquation, genericModelModelMath.modelEquation) &&
        Objects.equals(this.fittingProcedure, genericModelModelMath.fittingProcedure) &&
        Objects.equals(this.exposure, genericModelModelMath.exposure) &&
        Objects.equals(this.event, genericModelModelMath.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class GenericModelModelMath {\n");
