...
public class PredictiveModelGeneralInformation {
  ...
  public PredictiveModelGeneralInformation identifier(String identifier) {
  ...
  **/
  ...
  public PredictiveModelGeneralInformation creator(List<Contact> creator) {
    this.creator = creator;
    return this;
  }

  public PredictiveModelGeneralInformation addCreatorItem(Contact creatorItem) {
  ...
  **/
  ...
  public PredictiveModelGeneralInformation software(String software) {
  ...
  **/
  ...
  public PredictiveModelGeneralInformation author(List<Contact> author) {
    this.author = author;
    return this;
  }

  public PredictiveModelGeneralInformation addAuthorItem(Contact authorItem) {
    if (this.author == null) {
  ...
  **/
  ...
  public PredictiveModelGeneralInformation format(String format) {
    this.format = format;
    return this;
  }
  ...
  **/
  ...
  public PredictiveModelGeneralInformation description(String description) {
  ...
  **/
  ...
  public PredictiveModelGeneralInformation language(String language) {
  ...
  **/
  ...
  public PredictiveModelGeneralInformation source(String source) {
    this.source = source;
    return this;
  }
  ...
  **/
  ...
  public PredictiveModelGeneralInformation availability(String availability) {
  ...
  **/
  ...
  public PredictiveModelGeneralInformation creationDate(LocalDate creationDate) {
  ...
  **/
  ...
  public PredictiveModelGeneralInformation url(String url) {
    this.url = url;
    return this;
  }
  ...
  **/
  ...
  public PredictiveModelGeneralInformation objective(String objective) {
  ...
  **/
  ...
  public PredictiveModelGeneralInformation reference(List<Reference> reference) {
    this.reference = reference;
    return this;
  }

  public PredictiveModelGeneralInformation addReferenceItem(Reference referenceItem) {
  ...
  **/
  ...
  public PredictiveModelGeneralInformation modificationDate(List<LocalDate> modificationDate) {
    this.modificationDate = modificationDate;
    return this;
  }

  public PredictiveModelGeneralInformation addModificationDateItem(LocalDate modificationDateItem) {
  ...
  **/
  ...
  public PredictiveModelGeneralInformation rights(String rights) {
    this.rights = rights;
    return this;
  }
  ...
  **/
  ...
  public PredictiveModelGeneralInformation name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public PredictiveModelGeneralInformation languageWrittenIn(String languageWrittenIn) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Software language used to write the model, e.g. R or MatLab")
  ...
  public PredictiveModelGeneralInformation modelCategory(ModelCategory modelCategory) {
  ...
  **/
  ...
  public PredictiveModelGeneralInformation status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PredictiveModelGeneralInformation predictiveModelGeneralInformation = (PredictiveModelGeneralInformation) o;
    return Objects.equals(this.identifier, predictiveModelGeneralInformation.identifier) &&
        Objects.equals(this.creator, predictiveModelGeneralInformation.creator) &&
        Objects.equals(this.software, predictiveModelGeneralInformation.software) &&
        Objects.equals(this.author, predictiveModelGeneralInformation.author) &&
        Objects.equals(this.format, predictiveModelGeneralInformation.format) &&
        Objects.equals(this.description, predictiveModelGeneralInformation.description) &&
        Objects.equals(this.language, predictiveModelGeneralInformation.language) &&
        Objects.equals(this.source, predictiveModelGeneralInformation.source) &&
        Objects.equals(this.availability, predictiveModelGeneralInformation.availability) &&
        Objects.equals(this.creationDate, predictiveModelGeneralInformation.creationDate) &&
        Objects.equals(this.url, predictiveModelGeneralInformation.url) &&
        Objects.equals(this.objective, predictiveModelGeneralInformation.objective) &&
        Objects.equals(this.reference, predictiveModelGeneralInformation.reference) &&
        Objects.equals(this.modificationDate, predictiveModelGeneralInformation.modificationDate) &&
        Objects.equals(this.rights, predictiveModelGeneralInformation.rights) &&
        Objects.equals(this.name, predictiveModelGeneralInformation.name) &&
        Objects.equals(this.languageWrittenIn, predictiveModelGeneralInformation.languageWrittenIn) &&
        Objects.equals(this.modelCategory, predictiveModelGeneralInformation.modelCategory) &&
        Objects.equals(this.status, predictiveModelGeneralInformation.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class PredictiveModelGeneralInformation {\n");
