...
public class HealthModelScope {
  ...
  public HealthModelScope spatialInformation(List<String> spatialInformation) {
    this.spatialInformation = spatialInformation;
    return this;
  }

  public HealthModelScope addSpatialInformationItem(String spatialInformationItem) {
  ...
  **/
  ...
  public HealthModelScope populationGroup(List<PopulationGroup> populationGroup) {
    this.populationGroup = populationGroup;
    return this;
  }

  public HealthModelScope addPopulationGroupItem(PopulationGroup populationGroupItem) {
  ...
  **/
  ...
  public HealthModelScope hazard(List<Hazard> hazard) {
    this.hazard = hazard;
    return this;
  }

  public HealthModelScope addHazardItem(Hazard hazardItem) {
    if (this.hazard == null) {
  ...
  **/
  ...
  public HealthModelScope generalComment(String generalComment) {
  ...
  **/
  ...
  public HealthModelScope temporalInformation(String temporalInformation) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HealthModelScope healthModelScope = (HealthModelScope) o;
    return Objects.equals(this.spatialInformation, healthModelScope.spatialInformation) &&
        Objects.equals(this.populationGroup, healthModelScope.populationGroup) &&
        Objects.equals(this.hazard, healthModelScope.hazard) &&
        Objects.equals(this.generalComment, healthModelScope.generalComment) &&
        Objects.equals(this.temporalInformation, healthModelScope.temporalInformation);
  }
  ...
  public String toString() {
    ...
    sb.append("class HealthModelScope {\n");
