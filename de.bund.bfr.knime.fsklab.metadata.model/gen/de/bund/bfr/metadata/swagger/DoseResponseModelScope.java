...
public class DoseResponseModelScope {
  ...
  public DoseResponseModelScope spatialInformation(List<String> spatialInformation) {
    this.spatialInformation = spatialInformation;
    return this;
  }

  public DoseResponseModelScope addSpatialInformationItem(String spatialInformationItem) {
  ...
  **/
  ...
  public DoseResponseModelScope populationGroup(List<PopulationGroup> populationGroup) {
    this.populationGroup = populationGroup;
    return this;
  }

  public DoseResponseModelScope addPopulationGroupItem(PopulationGroup populationGroupItem) {
  ...
  **/
  ...
  public DoseResponseModelScope hazard(List<Hazard> hazard) {
    this.hazard = hazard;
    return this;
  }

  public DoseResponseModelScope addHazardItem(Hazard hazardItem) {
    if (this.hazard == null) {
  ...
  **/
  ...
  public DoseResponseModelScope generalComment(String generalComment) {
  ...
  **/
  ...
  public DoseResponseModelScope temporalInformation(String temporalInformation) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DoseResponseModelScope doseResponseModelScope = (DoseResponseModelScope) o;
    return Objects.equals(this.spatialInformation, doseResponseModelScope.spatialInformation) &&
        Objects.equals(this.populationGroup, doseResponseModelScope.populationGroup) &&
        Objects.equals(this.hazard, doseResponseModelScope.hazard) &&
        Objects.equals(this.generalComment, doseResponseModelScope.generalComment) &&
        Objects.equals(this.temporalInformation, doseResponseModelScope.temporalInformation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(spatialInformation, populationGroup, hazard, generalComment, temporalInformation);
  }
  ...
  public String toString() {
    ...
    sb.append("class DoseResponseModelScope {\n");
