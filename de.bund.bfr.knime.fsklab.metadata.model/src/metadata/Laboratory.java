...
public interface Laboratory extends EObject {
	/**
	 * Returns the value of the '<em><b>Laboratory Accreditation</b></em>' attribute list.
	 * The list contents are of type {@link java.lang.String}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Laboratory Accreditation</em>' attribute list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Laboratory Accreditation</em>' attribute list.
	 * @see metadata.MetadataPackage#getLaboratory_LaboratoryAccreditation()
	 * @model required="true"
	 * @generated
	 */
	EList<String> getLaboratoryAccreditation();
