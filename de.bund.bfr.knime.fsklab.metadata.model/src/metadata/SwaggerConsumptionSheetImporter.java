...
public class SwaggerConsumptionSheetImporter  {
	 ...
	 protected int QUALITY_MEASURES__SSE = 109;
	 protected int QUALITY_MEASURES__MSE = 110;
	 protected int QUALITY_MEASURES__RMSE = 111;
	 protected int QUALITY_MEASURES__RSQUARE = 112;
	 protected int QUALITY_MEASURES__AIC = 113;
	 protected int QUALITY_MEASURES__BIC = 114;
	 ...
	 protected int BG_STUDY_SAMPLE_ROW = 82;
	 protected int BG_DIET_ASSESS_ROW = 88;
	 protected int BG_EVENT_ROW = 94;
	 protected int BG_LABORATORY_ROW = 95;
	 protected int BG_ASSAY_ROW = 101;
	 protected int BG_QUALITY_MEAS_ROW = 109;
	 protected int BG_Model_EQ_ROW = 109;

	 protected int MM_PARAMETER_ROW = 119;
	protected int MM_FITTING_PROCEDURE_ROW = 135;
