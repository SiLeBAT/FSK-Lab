...
public interface MetadataPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Study Sample</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
  int DATA_BACKGROUND__STUDY_SAMPLE = 1;

  /**
	 * The feature id for the '<em><b>Dietary Assessment Method</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
  int DATA_BACKGROUND__DIETARY_ASSESSMENT_METHOD = 2;
  ...
  /**
	...
	/**
	 * The feature id for the '<em><b>Pattern Consumption</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	...
	/**
	 * The feature id for the '<em><b>Population Age</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	...
	/**
	 * Returns the meta object for the containment reference list '{@link metadata.DataBackground#getStudySample <em>Study Sample</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Study Sample</em>'.
  ...
  /**
	 * Returns the meta object for the containment reference list '{@link metadata.DataBackground#getDietaryAssessmentMethod <em>Dietary Assessment Method</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Dietary Assessment Method</em>'.
  ...
  /**
	...
	/**
	 * Returns the meta object for the containment reference list '{@link metadata.PopulationGroup#getPatternConsumption <em>Pattern Consumption</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Pattern Consumption</em>'.
	...
	/**
	 * Returns the meta object for the containment reference list '{@link metadata.PopulationGroup#getPopulationAge <em>Population Age</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Population Age</em>'.
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Study Sample</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
		 * @generated
		 */
    EReference DATA_BACKGROUND__STUDY_SAMPLE = eINSTANCE.getDataBackground_StudySample();

    /**
		 * The meta object literal for the '<em><b>Dietary Assessment Method</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
		 * @generated
		 */
    EReference DATA_BACKGROUND__DIETARY_ASSESSMENT_METHOD = eINSTANCE.getDataBackground_DietaryAssessmentMethod();
    ...
    /**
		...
		/**
		 * The meta object literal for the '<em><b>Pattern Consumption</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '<em><b>Population Age</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
