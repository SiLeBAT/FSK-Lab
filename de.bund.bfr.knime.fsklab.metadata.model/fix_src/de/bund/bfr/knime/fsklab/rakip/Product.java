...
public class Product {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(environmentDescription, environmentName, environmentUnit, expirationDate,
        fisheriesArea, originArea, originCountry, packaging, productTreatment, productionDate,
        productionMethod);
  }
