...
# Check Gitlab repo
git clone -b main --single-branch --depth=1 https://$GITLAB_USER:$GITLAB_TOKEN@gitlab.bfr.berlin/silebat/$REPO.git
...
# Push build
git push https://$GITLAB_NAME:$GITLAB_TOKEN@gitlab.bfr.berlin/silebat/$REPO.git main