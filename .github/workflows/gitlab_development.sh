...
# Check Gitlab repo
git clone -b 4.4 --single-branch --depth=1 https://$GITLAB_NAME:$GITLAB_TOKEN@gitlab.bfr.berlin/silebat/$REPO.git
...
# Push build
git push https://$GITLAB_NAME:$GITLAB_TOKEN@gitlab.bfr.berlin/silebat/$REPO.git 4.4