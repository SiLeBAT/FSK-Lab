...
class FskEditorNodeSettings {
  ...
  public void saveSettings(final NodeSettingsWO settings) {
    ...
    settings.addLong("createdDate",
        metaData.createdDate == null ? 0 : metaData.createdDate.getTime());
    settings.addLong("modifiedDate",
        metaData.modifiedDate == null ? 0 : metaData.modifiedDate.getTime());
  ...
  public void loadSettings(final NodeSettingsRO settings) {
    ...
    metaData.software =
        StringUtils.isEmpty(softwareString) ? null : FskMetaData.Software.valueOf(softwareString);
