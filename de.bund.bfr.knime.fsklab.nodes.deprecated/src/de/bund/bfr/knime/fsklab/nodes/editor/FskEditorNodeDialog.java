...
class FskEditorNodeDialog extends DataAwareNodeDialogPane {
	...
	class MetaDataPanel extends JPanel {
		...
		public MetaDataPanel() {
			...
			final List<JLabel> labels = Arrays
					.asList("Model name:", "Model id:", "Model link:", "Organism:", "Organism details:", "Matrix:",
							"Matrix details:", "Creator:", "Family name:", "Contact:", "Software:",
							"Reference description:", "Reference description link:", "Created date:", "Modified date:",
							"Notes:", "Is curated?:", "Model type:", "Model subject:", "Food process:", "Has data:")
					.stream().map(JLabel::new).collect(Collectors.toList());

			final List<JComponent> inputs = Arrays.asList(modelNameComp, modelIdComp, modelLinkComp, organismComp,
					organismDetailsComp, matrixComp, matrixDetailsComp, creatorComp, familyNameComp, contactComp,
					softwareComp, referenceDescriptionComp, referenceDescriptionLinkComp, createdDateComp,
					modifiedDateComp, notesComp, curatedComp, typeComp, subjectComp, foodProcessComp, hasDataComp);
