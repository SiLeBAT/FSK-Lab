...
curl -u $BINTRAY_USER:$BINTRAY_KEY -X DELETE https://api.bintray.com/packages/silebat/fsklab_icpmf/update/versions/version

# Create version 'version'
curl -u $BINTRAY_USER:$BINTRAY_KEY -H "Content-Type: application/json" -X POST -d '{"name": "version", "description": ""}' https://api.bintray.com/packages/silebat/fsklab_icpmf/update/versions
