...
public class RAKIPSheetImporterTest {
	...
	public void testGeneralInformation() throws IOException {
		...
		GeneralInformation generalInformation = importer.retrieveGeneralInformation(sheet0);
	...
	public void testCreator() throws IOException {
		...
		Contact contact = importer.retrieveContact(sheet0.getRow(3));
	...
	public void testReference() throws IOException {
		...
		Reference reference = importer.retrieveReference(sheet0.getRow(14));
	...
	public void testProduct() throws IOException {
		...
		{
			Product product39 = importer.retrieveProduct(sheet0.getRow(38));
		...
		{
			Product product40 = importer.retrieveProduct(sheet0.getRow(39));
		...
		{
			Product product41 = importer.retrieveProduct(sheet0.getRow(40));
	...
	public void testHazard() throws IOException {
		...
		{
			Hazard hazard39 = importer.retrieveHazard(sheet0.getRow(38));
	...
	public void testPopulationGroup() throws IOException {
		...
		{
			PopulationGroup populationGroup39 = importer.retrievePopulationGroup(sheet0.getRow(38));
	...
	public void testStudy() throws IOException {
		...
		Study study = importer.retrieveStudy(sheet0);
	...
	public void testStudySample() throws IOException {
		...
		StudySample studySample97 = importer.retrieveStudySample(sheet0.getRow(96));
		...
		StudySample studySample98 = importer.retrieveStudySample(sheet0.getRow(97));
		...
		StudySample studySample99 = importer.retrieveStudySample(sheet0.getRow(98));
	...
	public void testDietaryAssessmentMethod() throws IOException {
		...
		DietaryAssessmentMethod method104 = importer.retrieveDietaryAssessmentMethod(sheet0.getRow(103));
		...
		DietaryAssessmentMethod method105 = importer.retrieveDietaryAssessmentMethod(sheet0.getRow(104));
		...
		DietaryAssessmentMethod method106 = importer.retrieveDietaryAssessmentMethod(sheet0.getRow(105));
	...
	public void testLaboratory() throws IOException {
		...
		Laboratory laboratory111 = importer.retrieveLaboratory(sheet0.getRow(110));
		...
		Laboratory laboratory112 = importer.retrieveLaboratory(sheet0.getRow(111));
		...
		Laboratory laboratory113 = importer.retrieveLaboratory(sheet0.getRow(112));
	...
	public void testAssay() throws IOException {
		...
		Assay assay118 = importer.retrieveAssay(sheet0.getRow(117));
		...
		Assay assay119 = importer.retrieveAssay(sheet0.getRow(118));
		...
		Assay assay120 = importer.retrieveAssay(sheet0.getRow(119));
	...
	public void testParameter() throws IOException {
		...
		Parameter param133 = importer.retrieveParameter(sheet0.getRow(132));
	...
	public void testQualityMeasures() throws IOException {
		...
		JsonObject measures = importer.retrieveQualityMeasures(sheet0);
