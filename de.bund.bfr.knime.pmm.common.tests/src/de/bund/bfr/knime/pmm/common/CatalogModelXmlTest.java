...
public class CatalogModelXmlTest {
	...
	public void testConstructors() throws Exception {
		...
		final CatalogModelXml catalog1 = new CatalogModelXml(0, "name", "formula", 0, "dbuuid");
		...
		final Element element = new Element(CatalogModelXml.ELEMENT_CATALOGMODEL);
		...
		final CatalogModelXml catalog2 = new CatalogModelXml(element);
	...
	public void testToXmlElement() throws Exception {
		final CatalogModelXml catalog = new CatalogModelXml(0, "name", "formula", 0, "dbuuid");
		catalog.comment = "comment";
		final Element element = catalog.toXmlElement();
