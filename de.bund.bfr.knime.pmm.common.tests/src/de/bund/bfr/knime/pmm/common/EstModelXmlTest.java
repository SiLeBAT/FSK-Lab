...
public class EstModelXmlTest {
	...
	public void testConstructors() {
		...
		final EstModelXml model1 = new EstModelXml(0, "name", .0, .0, .0, .0, .0, 1, true, 1);
		...
		final Element element = new Element(EstModelXml.ELEMENT_ESTMODEL);
		...
		final EstModelXml model3 = new EstModelXml(element);
	...
	public void testToXmlElement() throws Exception {
		...
		final EstModelXml model = new EstModelXml(0, "name", .0, .0, .0, .0, .0, 1, true, 1, "dbuuid");
		final Element element = model.toXmlElement();
