...
public class FskPortObjectUtil {
  ...
  /**
   * 
   * Method to deserialize an object by temporarily setting a new classloader to work around
   * a deserialization bug in KNIME.
   * 
   ...
   * @throws IOException
   */
  public static <T> T deserializeAfterClassloaderReset(ClassLoader classLoader, ObjectMapper mapper, InputStream in, Class<T> valueType)
      throws IOException
  {
