...
public interface IRController extends AutoCloseable {
	...
	/**
	 * Marker class for exception occurring when trying to use RController when not
	 * initialized.
	 */
	 ...
	 *            the R expression to evaluate
	 * @param resolve
	 *            Whether to resolve the resulting reference, if <code>false</code>
	 *            null returned (unless exception is thrown)
	 ...
	 * @param resolve
	 *            Whether to resolve the resulting reference
	 * @return Result of the evaluation, either a reference (if resolve is false) or
	 *         the resolved value.
	 * @throws RException
	 ...
	 *            R variable name
	 * @param value
	 *            REXP value to assign to the variable
	 * @param exec
	 *            Execution Monitor
	 * @throws RException
	 * @throws CanceledExecutionException
	...
	/**
	 * @param workspaceFile
	 *            R workspace file to read
	 * @param tempWorkspaceFile
	 *            the workspace file
	 * @param exec
	 *            execution monitor to report progress on
	 * @return List of libraries which were previously imported in the workspace.
	 *         See {@link #importListOfLibrariesAndDelete()}.
	 * @throws RException
	 * @throws CanceledExecutionException
	 */
	 ...
	 *            Flow variables to export into the R workspace
	 * @param name
	 *            Name for the R variable to contain the flow variables
	 * @param exec
	 *            Execution monitor
	 * @throws RException
	 * @throws CanceledExecutionException
	 ...
	 *
	 * @param string
	 *            R expression (variable for e.g.) to retrieve a data.frame which is
	 *            then converted into a BufferedDataTable.
	 * @param nonNumbersAsMissing
	 *            Convert NaN and Infinity to {@link MissingCell}.
	 * @param exec
	 *            Execution context for creating the table and monitoring execution.
	...
	/**
	 * Get list of libraries imported in the current session and then delete those
	 * imports.
	 *
