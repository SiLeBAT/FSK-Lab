...
import de.bund.bfr.knime.fsklab.nodes.rakip.editor.NodeDialog;
import de.bund.bfr.knime.fsklab.nodes.rakip.editor.NodeModel;
...
public class NodeFactory extends org.knime.core.node.NodeFactory<NodeModel> {
  ...
  /** {@inheritDoc} */
  @Override
  public org.knime.core.node.NodeView<NodeModel> createNodeView(int viewIndex,
      NodeModel nodeModel) {
    return null;
  }
