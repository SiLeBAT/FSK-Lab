joiner = function () {
  ...
  function editModelsPool(key, modelParameters, modelName, individualMetadata) {
  ...
  function reoderTool() {
    ...
    $('.selectForOrder').on('focus', function () {
      ...
      if (window.toogle) {
        ...
        editModelsPool(previous, newParams, modelsPool[previous]['modelName'], modelsPool[previous]['metadata'])
        editModelsPool(newValueText, oldParams, modelsPool[newValueText]['modelName'], modelsPool[newValueText]['metadata']);
      }
  ...
  function drawWorkflow() {
    ...
    _representation.firstModelName ? editModelsPool('firstModel', _representation.firstModelParameters, _representation.firstModelName, _representation.firstModel) : '';
    _representation.secondModelName ? editModelsPool('secondModel', _representation.secondModelParameters, _representation.secondModelName, _representation.secondModel) : '';
    _representation.thirdModelName ? editModelsPool('thirdModel', _representation.thirdModelParameters, _representation.thirdModelName, _representation.thirdModel) : '';
    _representation.fourthModelName ? editModelsPool('fourthModel', _representation.fourthModelParameters, _representation.fourthModelName, _representation.fourthModel) : '';
