 ...
 *************************************************************************************************
 */
package de.bund.bfr.knime.fsklab.nodes.common;
...
public class RunnerNodeSettings {
	...
	/** Selected simulation. */
	public String simulation = "defaultSimulation";
	...
	public void load(final NodeSettingsRO settings) throws InvalidSettingsException {
		...
		/*
		 * If CFG_SIMULATION is missing (in case of old workflows) then restore to
		 * defaultSimulation. simulation).
		 */
		simulation = settings.getString(CFG_SIMULATION, "defaultSimulation");
	}
