			...
			if (row != null) {
				...
				if ((serial == null || serial.trim().isEmpty())) {
					...
					if (storedRows.containsKey(crc32Out)) {
						...
						newCell = newRow.createCell(0,  CellType.STRING);
						newCell.setCellStyle(cs);
						newCell.setCellValue(backSerial);
						newCell = newRow.createCell(1, CellType.STRING);
						newCell.setCellStyle(cs);
						newCell.setCellValue(serial + ".0");
						newCell = newRow.createCell(2, CellType.STRING);
						newCell.setCellValue(adressInsp);
						newCell = newRow.createCell(3, CellType.STRING);
						newCell.setCellValue(prodNameOut);
						newCell = newRow.createCell(4, CellType.STRING);
						newCell.setCellValue(prodNumOut);
						if (treatmentOut != null) {
							newCell = newRow.createCell(5, CellType.STRING);
							newCell.setCellValue(treatmentOut);
						}
						newCell = newRow.createCell(6, CellType.STRING);
						newCell.setCellValue(lotNo_Out);
						newCell = newRow.createCell(7, CellType.STRING);
						newCell.setCellValue(dayPDOut);
						newCell = newRow.createCell(8, CellType.STRING);
						newCell.setCellValue(monthPDOut);
						newCell = newRow.createCell(9, CellType.STRING);
						newCell.setCellValue(yearPDOut);
						newCell = newRow.createCell(10, CellType.STRING);
						newCell.setCellValue(dayMHDOut);
						newCell = newRow.createCell(11, CellType.STRING);
						newCell.setCellValue(monthMHDOut);
						newCell = newRow.createCell(12, CellType.STRING);
						newCell.setCellValue(yearMHDOut);
						newCell = newRow.createCell(13, CellType.STRING);
						newCell.setCellValue(dayOut);
						newCell = newRow.createCell(14, CellType.STRING);
						newCell.setCellValue(monthOut);
						newCell = newRow.createCell(15, CellType.STRING);
						newCell.setCellValue(yearOut);
						newCell = newRow.createCell(16, CellType.STRING);
						newCell.setCellValue(amountKG_Out);
						newCell = newRow.createCell(17, CellType.STRING);
						newCell.setCellValue(numPUOut);
						newCell = newRow.createCell(18, CellType.STRING);
						newCell.setCellValue(typePUOut);
						newCell = newRow.createCell(19, CellType.STRING);
						newCell.setCellValue(adressRec);
						newCell = newRow.createCell(20, CellType.STRING);
						newCell.setCellStyle(cs);
						newCell.setCellValue(contactPerson);
						newCell = newRow.createCell(23, CellType.STRING);
						newCell.setCellStyle(cs);
						newCell.setCellValue(oc);
						newCell = newRow.createCell(24, CellType.STRING);
						newCell.setCellStyle(cs);
						newCell.setCellValue(cqr);
						newCell = newRow.createCell(26, CellType.STRING);
						newCell.setCellStyle(cs);
					...
					if (storedRows.containsKey(crc32In)) {
						...
						newCell.setCellStyle(cs);
						newCell.setCellValue(contactPerson);
						newCell = newRow.createCell(21, CellType.STRING);
						newCell.setCellStyle(cs);
						newCell.setCellValue(ec);
						newCell = newRow.createCell(22, CellType.STRING);
						newCell.setCellStyle(cs);
						...
						newCell.setCellStyle(cs);
						newCell.setCellValue(cqr);
						newCell = newRow.createCell(25, CellType.STRING);
						newCell.setCellStyle(cs);
